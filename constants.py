...
DEFAULT_GLOSSARY = {
    ...
    # Tinkers' Construct 계열
    "Tinkers": "팅커스",
    "Tinkers' Construct": "팅커스 컨스트럭트",
    "Tinker": "팅커",
    "Smeltery": "제련소",
    "Seared Brick": "그을린 벽돌",
    "Seared Stone": "그을린 돌",
    ...
    "Thermal Foundation": "써멀 파운데이션",
    "Thermal Series": "써멀 시리즈",
    "Applied Energistics": "어플라이드 에너제틱스",
    "Applied Energistics 2": "어플라이드 에너제틱스 2",
    "AE2": "AE2",
    "Refined Storage": "리파인드 스토리지",
    "Immersive Engineering": "이머시브 엔지니어링",
    "Botania": "보타니아",
    "Thaumcraft": "사움크래프트",
    "Blood Magic": "블러드 매직",
    "Astral Sorcery": "아스트랄 소서리",
    "Ars Nouveau": "아스 누보",
    "Ender IO": "엔더 IO",
    "Draconic Evolution": "드라코닉 에볼루션",
    "Avaritia": "아바리티아",
    "Twilight Forest": "황혼의 숲",
    "Industrial Foregoing": "인더스트리얼 포고잉",
    "PneumaticCraft": "뉴매틱크래프트",
    "Occultism": "오컬티즘",
    "Mystical Agriculture": "미스티컬 애그리컬처",
    "Farmer's Delight": "파머스 딜라이트",
    "Waystones": "웨이스톤",
    "Sophisticated Backpacks": "소피스티케이티드 백팩",
    "Iron Jetpacks": "아이언 제트팩",
    "Flux Networks": "플럭스 네트워크",
    "Powah": "포와",
    "ProjectE": "프로젝트E",
    "Silent Gear": "사일런트 기어",
    "Nature's Compass": "자연의 나침반",
    "Explorer's Compass": "탐험가의 나침반",
    "Just Enough Items": "저스트 이너프 아이템즈",
    "JEI": "JEI",
    "FTB Quests": "FTB 퀘스트",
    "Curios": "큐리오스",
    "Quark": "쿼크",
    ...
    "Alfsteel": "알프스틸",
    "Draconium": "드라코늄",
    "Awakened Draconium": "각성된 드라코늄",
    "Neutronium": "뉴트로늄",
    "Infinity Ingot": "인피니티 주괴",
    "Electrotine": "일렉트로틴",
    "Certus Quartz": "서투스 석영",
    "Charged Certus Quartz": "충전된 서투스 석영",
    "Certus Quartz Dust": "서투스 석영 가루",
    "Fluix": "플루익스",
    "Fluix Crystal": "플루익스 결정",
    "Constantan": "콘스탄탄",
    ...
    "Fluxbore": "플럭스보어",
    "Fluxsaw": "플럭스톱",
    "Crescent Hammer": "초승달 망치",
    "Akashic Tome": "아카식 기록서",
    "Morph-o-Tool": "모프 툴",
}
