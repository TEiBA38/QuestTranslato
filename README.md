...
- **다중 AI 번역 엔진 지원**: Gemini, OpenAI(ChatGPT), DeepL, Google Translate Local AI
- **스마트 모드팩 자동 인식**: CurseForge, Prism Launcher, MultiMC의 인스턴스 폴더를 자동으로 스캔하고 모드팩 썸네일과 함께 UI로 렌더링합니다.
